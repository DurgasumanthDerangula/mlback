...
app = Flask(__name__)
CORS(app, origins=["http://localhost:3000","https://healthfrontend3.vercel.app","https://healthback-3.onrender.com"])
...
def predict_score():
    try:
        ...
        api_url = f"https://healthback-3.onrender.com/api/scores/history/{user_id}"
